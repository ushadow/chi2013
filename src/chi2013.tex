...
The idea of backoff to a lower order model when a higher order more specific model is not available is commonly used in language modelling for speech recognition~\cite{Zitouni:2007}. When unseen \textit{n}-gram events are encountered, the backoff class based \text{n}-gram language model is used.
