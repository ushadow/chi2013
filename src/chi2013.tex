...
\title{Making Touchscreen Keyboards Adaptive to Keys, Hand Postures,  and
...
\author{
  ...
  \alignauthor \ Kurt Partridge\google\\
...
%
  \sharedaffiliation
  \begin{tabular}{ccc}
  \affaddr{{\mit}Massachusetts Institute of Technology{\ }} & &
  \affaddr{{\google}Google Inc.{\ }}
  \\
...
\begin{figure}[tb]
  ...
  \subfigure[Key-adaptive model]{
    \includegraphics[width=0.47\columnwidth]{figures/key-model-embed-font.pdf}
    \label{fig:key-adaptive}
  } ~
  \subfigure[Posture- and key-adaptive model for one-finger input]{
    \includegraphics[width=0.47\columnwidth]{figures/posture-t-embed-font.pdf}
    \label{fig:one-finger}
  }
  \subfigure[Posture- and key-adaptive model for two-thumb input]{
    \includegraphics[width=0.47\columnwidth]{figures/posture-tt-embed-font.pdf}
    \label{fig:two-thumb}
  }
